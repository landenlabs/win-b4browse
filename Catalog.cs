    ...
    public static class Catalog
    {
        ...
        public static readonly Section[] Sections =
        {
            ...
            new() { Category = "Accounts & usage", Title = "Awake", Key = "awake",
                    Banner = "Recent power events (boot / wake / sleep / shutdown)", ReportTitle = "Power Events",
                    Producers = new Func<CheckGroup>[] { SafetyChecks.WakeSourcesHeader, SafetyChecks.CheckAwake }, BuildView = TabViews.BuildAwake },
